...
const getPrevYear = (d) => (!d || d.length < 4) ? null : String(parseInt(d.substring(0, 4), 10) - 1) + d.substring(4);
...
function renderTable() {
    ...
    if (!userDate2 || !dates.includes(userDate2)) {
        let pYear = getPrevYear(userDate1);
        userDate2 = (pYear && dates.includes(pYear)) ? pYear : (dates[1] || dates[0]);
    }
    ...
    root.innerHTML = `
        ...
        <table style="table-layout: fixed; width: 100%;">
            ...
            <thead>
                <tr>
                    <th>Özet Gelir Tablosu<br><span class="sub-title" style="margin-left:0;">Bin TRY</span></th>
