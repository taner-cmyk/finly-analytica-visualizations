...
function renderTable() {
    ...
    // Tarihleri al ve büyükten küçüğe sırala
    ...
    // 2. TARİH (BİLANÇO MANTIĞI): Max tarihten hemen bir önceki tarih (Örn: 2025/12 ise 2025/09)
    if (!userSelectedDate2 || !availableDates.includes(userSelectedDate2)) {
        userSelectedDate2 = availableDates[1] || availableDates[0];
    }
    ...
    let html = `
        <table>
            <thead>
                <tr>
                    <th>Özet Bilanço<span class="sub-title">Bin TRY</span></th>
                    <th>
...
document.addEventListener('click', (e) => {
    // Eğer tıklanan yer '.dropdown-wrapper' (buton veya menü) İÇİNDE DEĞİLSE kapat
